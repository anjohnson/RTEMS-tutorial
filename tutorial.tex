...
\begin{alltt}
../\BINUTILS/configure --target=powerpc-rtems\rtemsToolVersion --prefix=/opt/rtems
\end{alltt}
...
\begin{alltt}
../\GCC/configure --target=powerpc-rtems\rtemsToolVersion --prefix=/opt/rtems \verb@\@
...
../rtems-\rtemsVersion/configure \verb@--target=powerpc-rtems\rtemsToolVersion --prefix=/opt/rtems \@
...
\begin{alltt}
cd /usr/local/source/RTEMS/build
../rtems-\rtemsVersion/configure \verb@--target=m68k-rtems\rtemsToolVersion --prefix=/opt/rtems \@
  \verb@  --enable-cxx --enable-rdbg --disable-tests --enable-networking \@
...
\begin{verbatim}
export RTEMS_MAKEFILE_PATH=/opt/rtems/powerpc-rtems\rtemsToolVersion/mvme2100
\end{verbatim}
